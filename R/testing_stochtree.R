...
data <- generate_data_2(250, is_te_hetero = F, is_mu_nonlinear = T, seed = 40, RCT = FALSE, z_diff = T)
...
#'all'
#
data <- generate_data_2(500, is_te_hetero = T, is_mu_nonlinear = T, seed = 40, RCT = FALSE, z_diff = F)
